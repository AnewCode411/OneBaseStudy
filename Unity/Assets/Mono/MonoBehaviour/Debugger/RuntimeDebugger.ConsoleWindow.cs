    ...
    public sealed partial class RuntimeDebuger : MonoSingleton<RuntimeDebuger>
    {
        ...
        private sealed class ConsoleWindow : IDebuggerWindow
        {
            ...
            public void Initialize(params object[] args)
            {
                ...
                m_LockScroll = m_LastLockScroll = true;//m_SettingComponent.GetBool("Debugger.Console.LockScroll", true);
                m_InfoFilter = m_LastInfoFilter = true;//m_SettingComponent.GetBool("Debugger.Console.InfoFilter", true);
                m_WarningFilter = m_LastWarningFilter = true;//m_SettingComponent.GetBool("Debugger.Console.WarningFilter", true);
                m_ErrorFilter = m_LastErrorFilter = true;//m_SettingComponent.GetBool("Debugger.Console.ErrorFilter", true);
                m_FatalFilter = m_LastFatalFilter = true;//m_SettingComponent.GetBool("Debugger.Console.FatalFilter", true);
            }
