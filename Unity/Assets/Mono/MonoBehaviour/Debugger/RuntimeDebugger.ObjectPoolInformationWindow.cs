    ...
    public sealed partial class RuntimeDebugger : MonoSingleton<RuntimeDebugger>
    {
        ...
        private sealed class ObjectPoolInformationWindow : ScrollableDebuggerWindowBase
        {
            ...
            protected override void OnDrawScrollableWindow()
            {
                ...
                {
                    // DrawItem("Object Pool Count", m_ObjectPool.Count.ToString());
                }
                GUILayout.EndVertical();
                // Entity[] objectPools = m_ObjectPool.GetAllObjectPools(true);
            ...
            // private void DrawObjectPool(Entity objectPool)
            // {
